...
export default function Terms() {
  ...
  const sections = [
    ...
    },
    {
      ...
      content: "CAVS provides an anonymous voting platform designed for members of CUET (Chittagong University of Engineering and Technology). Our platform allows users to participate in polls and surveys anonymously while respecting and protecting their privacy."
    },
    {
      title: "3. Eligibility",
      content: "To use CAVS, you must be a member of CUET with valid credentials to authenticate via our OAuth system. The information we access during authentication is limited to what is necessary to confirm eligibility and will not include any sensitive information beyond what is strictly required for authentication."
    },
    {
      title: "4. User Responsibilities",
      content: "You agree to use CAVS in compliance with all applicable laws and regulations. You further agree not to:\n\n• Misrepresent your identity.\n• Attempt to bypass the security mechanisms of CAVS.\n• Submit any malicious code or engage in behavior that could harm the system or its users.\n• Engage in any form of vote manipulation or fraud.",
    },
    {
      title: "5. Privacy",
      content: (
    ...
    },
    {
      ...
      content: "CAVS is provided on an \"as-is\" basis. CUET and its developers make no warranties or representations regarding the availability, accuracy, or completeness of the service. You agree that CUET and its developers shall not be held liable for any damages arising from your use of CAVS."
    },
    {
